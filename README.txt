...
cd /usr/src/
wget https://github.com/janbar/tbs-dvb-driver/archive/refs/heads/v6.14.tar.gz
tar xvfz v6.14.tar.gz

tar xvfz tbs-dvb-driver-6.14/dvb-firmwares.tar.gz -C /lib/firmware
chown root:root /lib/firmware/*.fw

dkms add tbs-dvb-driver/6.14
dkms build tbs-dvb-driver/6.14
dkms install tbs-dvb-driver/6.14
