...
- Branch v6.3 : build drivers with Linux kernel version from 6.3 and up*.
...
cd /usr/src/
wget https://github.com/janbar/tbs-dvb-driver/archive/refs/heads/v6.3.tar.gz
tar xvfz v6.3.tar.gz

tar xvfz tbs-dvb-driver-6.3/dvb-firmwares.tar.gz -C /lib/firmware
chown root:root /lib/firmware/*.fw

dkms add tbs-dvb-driver/6.3
dkms build tbs-dvb-driver/6.3
dkms install tbs-dvb-driver/6.3
